...
## CONFUSION MATRICES
```{r}
#make confusion matrix for no interaction model using ideal threshold
...
plot_categorical <- function(variable) {
  ...
  geom_line(aes(linetype=as.factor(plot_data$indicator_variable))) +
    geom_hline(yintercept = 0.091)+
  labs(color="Sex", linetype=variable))
}
